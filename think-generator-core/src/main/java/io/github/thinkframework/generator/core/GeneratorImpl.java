...
import io.github.thinkframework.generator.core.command.ClearCommand;
...
public class GeneratorImpl<S,T> implements Generator<S,T> {
     ...
     */
    @Override
    public void clear() throws GeneratorRuntimeException{
        new ClearCommand(configuration).execute();
    }
}
