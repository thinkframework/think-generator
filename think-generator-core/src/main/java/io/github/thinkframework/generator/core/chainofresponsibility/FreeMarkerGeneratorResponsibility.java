 ...
 * @since 2017/3/24
 */
public class FreeMarkerGeneratorResponsibility<S,T> implements GeneratorResponsibility<S,T> {

    private static final Logger log = LoggerFactory.getLogger(FreeMarkerGeneratorResponsibility.class);
