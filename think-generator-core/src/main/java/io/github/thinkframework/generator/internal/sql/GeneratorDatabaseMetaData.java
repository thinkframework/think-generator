package io.github.thinkframework.generator.internal.sql;

import io.github.thinkframework.generator.exception.GeneratorRuntimeException;
import io.github.thinkframework.generator.internal.sql.databasemetadata.*;
import io.github.thinkframework.generator.internal.sql.databasemetadata.impl.*;
...
public class GeneratorDatabaseMetaData {
    ...
    public Table getTable(String tableName) throws GeneratorRuntimeException {
        Collection<Table> tables = getTables(tableName, getTableTypes().toArray(new String[]{}));
     ...
     * @return 表的集合
     */
    public Set<Table> getTables(String tableName) throws GeneratorRuntimeException {
        Set<Table> tables = getTables(tableName, getTableTypes().toArray(new String[]{}));
        return tables;
    }

    protected Set<Table> getTables(final String tableName, final String[] types) throws GeneratorRuntimeException {
        try (Connection connection = getDataSource().getConnection()) {
            DatabaseMetaData dbmd = connection.getMetaData();
