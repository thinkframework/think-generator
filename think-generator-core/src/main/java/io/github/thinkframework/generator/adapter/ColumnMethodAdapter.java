...
import io.github.thinkframework.generator.lang.reflect.ClazzMethodRemarksDecroate;
...
public class ColumnMethodAdapter implements ClazzMethod, Column {
    ...
    public static ClazzMethod buildMethod(Column column) {
        ...
        return new ClazzMethodRemarksDecroate<>(method,StringUtils.isNotEmpty(column.getRemarks()) ? column.getRemarks() : column.getColumnName());
    }
