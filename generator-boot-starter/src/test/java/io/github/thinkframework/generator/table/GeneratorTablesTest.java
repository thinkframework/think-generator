 ...
 * 容器测试
 */
public class GeneratorTablesTest {

    private static Logger logger = LoggerFactory.getLogger(GeneratorTablesTest.class);
    ...
    public void test() throws Exception {
        GeneratorTable generator = new GeneratorTable(generatorConfiguration);
        GeneratorTables generatorTables = new GeneratorTables(generator);
        generatorTables.generate(dataSource,"TEST");
    }
}
