...
/**
 * 账号表，电商公司里一个员工就对应着一个账号，每个账号给分配多个角色，同时这个账号也可以给分配多个权限实体原型.
 * @author unascribed
 * @version 1.0.0
* @since 1.0.0
 */
public class AuthAccountPrototype extends AbstractAuditingPrototype {
     ...
     * 如果他们测试需要当前实体的实体.
     */
    public static AuthAccount update(AuthAccount authAccount) {
