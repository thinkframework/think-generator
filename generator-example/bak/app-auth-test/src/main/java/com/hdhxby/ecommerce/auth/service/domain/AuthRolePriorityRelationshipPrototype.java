...
/**
 * 角色和权限的关系表，角色和权限是多对多的关系，一个角色可以对应多个权限，一个权限可以属于多个角色实体原型.
 * @author unascribed
 * @version 1.0.0
* @since 1.0.0
 */
public class AuthRolePriorityRelationshipPrototype extends AbstractAuditingPrototype {
     ...
     * 如果他们测试需要当前实体的实体.
     */
    public static AuthRolePriorityRelationship create() {
        return AuthRolePriorityRelationship.builder()
     ...
     * 如果他们测试需要当前实体的实体.
     */
    public static AuthRolePriorityRelationship update(AuthRolePriorityRelationship authRolePriorityRelationship) {
