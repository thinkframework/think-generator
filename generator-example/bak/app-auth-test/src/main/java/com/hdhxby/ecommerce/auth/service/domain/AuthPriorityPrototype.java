...
/**
 * 权限表，每个权限代表了系统中的一个菜单、按钮、URL请求实体原型.
 * @author unascribed
 * @version 1.0.0
* @since 1.0.0
 */
public class AuthPriorityPrototype extends AbstractAuditingPrototype {
     ...
     * 如果他们测试需要当前实体的实体.
     */
    public static AuthPriority create() {
        return AuthPriority.builder()
            .code(DEFAULT_CODE)
            .url(DEFAULT_URL)
     ...
     * 如果他们测试需要当前实体的实体.
     */
    public static AuthPriority update(AuthPriority authPriority) {
