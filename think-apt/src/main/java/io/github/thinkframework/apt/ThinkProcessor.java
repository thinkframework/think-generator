package io.github.thinkframework.apt;

import io.github.thinkframework.apt.annotation.Chain;
    ...
    在实际应用中需要对各个Class先做过滤以提高效率，避免对每个Class的内容都进行扫描*/
        for (Element e : roundEnv.getRootElements()) {
            ...
            for (Element el : e.getEnclosedElements()) {
                ...
                if (el.getKind().isField() && el.getAnnotation(Chain.class) != null && el.getModifiers().contains(Modifier.PUBLIC)) {
                    /*获取注解信息，生成代码片段*/
                    Chain meta = el.getAnnotation(Chain.class);
