...
//        new ImageTranscoder().
    ...
    public void afterPropertiesSet() {
        ...
        generatorSqlTable.setDataSource(dataSource);
        generatorSqlTable.setSql(sql);
        generatorSqlTable.afterPropertiesSet();
        add(new JScrollPane(generatorSqlTable));
    }

    public GeneratorSqlTable getGeneratorSqlTable() {
        return generatorSqlTable;
    }

    public void setGeneratorSqlTable(GeneratorSqlTable generatorSqlTable) {
        this.generatorSqlTable = generatorSqlTable;
    }
