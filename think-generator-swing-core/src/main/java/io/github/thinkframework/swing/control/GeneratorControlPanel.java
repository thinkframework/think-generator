...
import io.github.thinkframework.swing.control.table.GeneratorTable;
...
import io.github.thinkframework.swing.event.TreeEvent;
 ...
 */
@Slf4j
public class GeneratorControlPanel extends JPanel implements ApplicationContextAware, ResourceLoaderAware, MessageSourceAware, InitializingBean, ApplicationListener {
    ...
    public void onApplicationEvent(ApplicationEvent applicationEvent) {
        if (applicationEvent instanceof TreeEvent && "swing".equals(applicationEvent.getSource())) {
            addTablePanel(((TreeEvent) applicationEvent).getDataSourceName(), ((TreeEvent) applicationEvent).getTableName());
        }
    }
